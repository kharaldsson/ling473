...
# with open(targets_path, 'r', encoding='utf8') as f:
#     targs = f.readlines()
#
# targs = ['AAG', 'AAACA', 'CTAAA', 'TTA', 'GGGA', 'GATTCA', 'AAT']
# corpus = 'NNNNNaTTAAACATGGGAAGANNNNNNNaagattca'
#
# t = Trie()
# t.build_trie(targs)
# t.search(corpus, 'test')

process_files(targets_path, inputs_path)
